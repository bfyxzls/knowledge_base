...
- 请求示例：`http://localhost:8080/order/orders/clearArrears?access_token=69ff3003-dee1-40d5-a36f-c0c4fa55c431`
- 请求参数位置: `Request Body`
- 请求参数: 
    - `carPlates`: 车牌号数据
    - `remark`: 消除欠费的原因
...
- 请求地址：`localhost:8080/order/orders/{id}/modifyFee`

- 请求动作：`PUT`

- 请求示例：`http://localhost:8080/order/orders/10000010/modifyFee?access_token=69ff3003-dee1-40d5-a36f-c0c4fa55c431&fee=1000`
- 请求参数: 
    - `id`: 订单id
    - `fee`: 金额
...
- 请求地址：`localhost:8080/order/orders/{id}/orderLogs`

- 请求动作：`GET`

- 请求示例：`http://localhost:8080/order/orders/10000010/orderLogs?access_token=69ff3003-dee1-40d5-a36f-c0c4fa55c431`
- 请求参数: 
    - `id`: 订单id
    ...
    "data": [
        {
            ...
            "type": 2,
            "description": "修改应交金额",
            "time": "2017-11-20 09:00:00"
        }
    ]
}
  ```
  - 备注：type：1为消除欠费日志，2为修改应交金额日志，3为添加缴费记录日志
  
  ### 4.1.22 添加缴费记录

- 功能描述：添加缴费记录

- 请求地址：`localhost:8080/order/orders/{id}/addFeeRecord`

- 请求动作：`PUT`

- 请求示例：`http://localhost:8080/order/orders/10000010/addFeeRecord?access_token=69ff3003-dee1-40d5-a36f-c0c4fa55c431`
- 请求参数: 
    - `id`: 订单id
    - `payType`: 支付方式
    - `fee`: 金额
    - `payTime`: 支付时间
    - `isInvoiceIssued`: 是否已开发票
    - `employeeId`: 员工id
    - `employeeName`: 员工姓名
    - `phoneNum`: 员工手机号
    - `district`: 收费的区
...
```json
{
	"payType": 1,
	"fee": 1,
	"payTime": "2017-11-20 10:00:00",
	"isInvoiceIssued": false,
	"employeeId":1001,
	"employeeName":"tt",
	"phoneNum":"13145656777",
	"district":"蜀山区"
}
```
