...
- 请求地址：`http://domain/customer/roadSections？access_token&startMonth&endMonth&page&size`

- 请求动作：`GET`

- 请求示例：`http://localhost:8080/customer/roadSections?access_token=69ff3003-dee1-40d5-a36f-c0c4fa55c431&startMonth=2017-12&endMonth=2017-12&page=0&size=10`
