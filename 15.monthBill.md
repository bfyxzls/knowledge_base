...
- 功能描述: 用户在App上购买月票时，获取获取月票路段列表
- 调用端：`App`
- 请求地址: `http://localhost:8080/customer/parkingAreas/1000?access_token=69ff3003-dee1-40d5-a36f-c0c4fa55c431&startMonth=2017-12&endMonth=2017-12`
- 请求动作: `GET`
